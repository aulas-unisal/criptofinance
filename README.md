...
4. Dentro da pasta, criar um arquivo chamado `.env` e nele deve conter as seguintes variáveis: `API_URL=https://testnet.binance.vision/api`, `STREAM_URL=wss://testnet.binance.vision/ws/`, `API_KEY=valor gerado no passo 1`, `API_SECRET_KEY=valor gerado no passo 1`
